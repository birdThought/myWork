...
import com.lifeshs.product.thirdservice.domain.HuanxinCmdActionType;
import com.lifeshs.product.thirdservice.domain.HuanxinTargetType;
import com.lifeshs.product.utils.HttpUtils;
import com.lifeshs.product.utils.JSONHelper;
import com.lifeshs.product.thirdservice.domain.GroupHxDTO;
import com.lifeshs.product.thirdservice.domain.GroupMemberDTO;
import com.lifeshs.product.thirdservice.domain.HuanxinUserVO;
import com.lifeshs.product.thirdservice.domain.ResultDTO;
import com.lifeshs.product.domain.po.huanxin.TUnregistHx;
...
public class HuanXinService {
     ...
     *
     */
    public String createGroup(GroupHxDTO group) {
     ...
     * @return
     */
    public GroupHxDTO getGroup(String groupId) {
        ...
        GroupHxDTO group = new GroupHxDTO();
        group.setId(id);

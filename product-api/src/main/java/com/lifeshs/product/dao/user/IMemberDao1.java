...
import com.lifeshs.product.domain.vo.healthData.HealthPackageMeasurePO;
...
import com.lifeshs.product.domain.vo.user.MemberVO;
...
public interface IMemberDao1 {
     ...
     * @return
     */
    List<MemberUserDTO> findUserList(@Param("keyword") String keyword);
     ...
     * @return
     */
    List<User1PO> listUserByIds(@Param("ids") int[] ids);

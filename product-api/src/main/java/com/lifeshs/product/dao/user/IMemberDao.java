...
import com.lifeshs.product.domain.dto.notice.UserMeasurementReminderDTO;
import com.lifeshs.product.domain.dto.task.UserMeasurementReminderDetailDTO;
import com.lifeshs.product.domain.dto.user.*;
...
public interface IMemberDao {
     ...
     *  @return
     */
    MemberUserDTO getUser(@Param("id") Integer id);
     ...
     *  @return
     */
    MemberUserDTO getUserByUserName(@Param("userName") String userName);
     ...
     *  @return
     */
    MemberUserDTO getUserByUserNo(@Param("userNo") String userNo);
     ...
     *  @return
     */
    MemberUserDTO getUserByMobile(@Param("mobile") String mobile);
     ...
     *  @return
     */
    List<MemberUserDTO> listUserByGroupKey(@Param("groupKey") String groupKey);
     ...
     *  @param memberUserDTO
     */
    int updateUser(MemberUserDTO memberUserDTO);
     ...
     *  @return
     */
    int addUser(MemberUserDTO memberUserDTO);
     ...
     * @return
     */
    MemberUserDTO getUserByUId(String uId);
     ...
     *  @return
     */
    List<Address1DTO> listAddress(@Param("userId") Integer userId);
     ...
     *  @return
     */
    int saveAddress(Address1DTO addressDTO);
     ...
     *  @return
     */
    int updateAddress(Address1DTO addressDTO);
     ...
     *  @return
     */
    Address1DTO getAddress(@Param("id") int id, @Param("userId") int userId);
     ...
     */
    MemberUserDTO getUserByOpenId(@Param("openId") String openId);

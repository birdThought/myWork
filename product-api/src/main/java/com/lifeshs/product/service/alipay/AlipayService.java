package com.lifeshs.product.service.alipay;

import com.lifeshs.product.service.alipay.config.AlipayAndroidConfig;
import com.lifeshs.product.service.alipay.config.AlipayConfig;
import com.lifeshs.product.service.alipay.sign.RSA;
import com.lifeshs.product.service.alipay.util.AlipayCore;
import com.lifeshs.product.service.alipay.util.OrderInfoUtil2_0;
	...
	public static String requestTradeRefund (String sign, String tradeNo, Double refundAmount, String refundReason) {
		...
		HttpUtils.getResultEntity(url, null, null, HttpUtils.GET, true,  new HttpUtils.HttpCallBack() {
			...
			public void resultCallBack(Object result) {
				...
				Map map = JSONHelper.toHashMap(result);

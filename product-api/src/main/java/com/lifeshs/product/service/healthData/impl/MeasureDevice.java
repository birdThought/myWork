...
import com.lifeshs.product.common.constants.healthData.FMRank;
...
import com.lifeshs.product.dao.healthData.IHealthDescriptionDao;
import com.lifeshs.product.dao.user.IUserInfoReadDao;
import com.lifeshs.product.domain.dto.notice.healthWarningCacheModel;
...
import com.lifeshs.product.thirdservice.UMengPushService;
...
public abstract class MeasureDevice<T> extends CommonServiceImpl {
   ...
   /* @Autowired
    com.lifeshs.product.api.service.user.service1.member.IMemberService memberService1;*/

    @Resource(name = "measureAnalysisServiceImpl")
    protected IMeasureAnalysisService measureAnaylsisService;
     ...
     * @author wuj
     */
    protected void updateUserIsOverstep(int userId, Integer hasWarning, DeviceType deviceType, Date measureDate) throws OperationException {
     ...
     */
    protected void sendWarningSMS(Integer userId, String name, String message, DeviceType deviceType, String deviceName, long status) {
...
//          if (value < max) {  // 正常值 修改为包左包右
     ...
     *  @param date 异常日期
     */
    protected void saveWarningMessage(int userId, DeviceType deviceType, Date date) throws DataBaseException {

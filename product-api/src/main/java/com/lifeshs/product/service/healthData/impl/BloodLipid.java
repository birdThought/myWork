...
import com.lifeshs.product.dao.healthData.IBloodLipidDao;
import com.lifeshs.product.domain.dto.healthData.NormalHealthPackageDTO;
import com.lifeshs.product.domain.dto.healthData.BloodLipidDTO;
...
import com.lifeshs.product.domain.po.device.TMeasureBloodlipid;
...
public class BloodLipid extends MeasureDevice<BloodLipidDTO> implements IMeasureDevice<BloodLipidDTO> {
    ...
    private final DeviceType deviceType = DeviceType.BloodLipid;
    @Autowired
    IBloodLipidDao bloodLipidDao;
    @Override

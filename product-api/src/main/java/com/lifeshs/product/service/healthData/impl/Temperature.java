...
import com.lifeshs.product.common.constants.healthData.DataTypeEnum;
...
import com.lifeshs.product.domain.po.device.TMeasureTemperature;
...
public class Temperature extends MeasureDevice<TMeasureTemperature> implements IMeasureDevice<Map<String, Object>> {
    ...
    private final DeviceType deviceType = DeviceType.Temperature;

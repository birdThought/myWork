...
import com.lifeshs.product.common.constants.jsonAttribute.record.Diet;
import com.lifeshs.product.common.constants.jsonAttribute.record.RecordSport;
...
import com.lifeshs.product.domain.dto.healthData.HealthStandardValueEx;
...
import com.lifeshs.product.service.healthData.impl.HealthStandard;
import com.lifeshs.product.service.healthData.impl.MeasureDevice;
...
public class AppBaseService {
            ...
            if (value instanceof Date) {
                ...
                if (value instanceof String) {
                    ...
                    if (key.equals("image") || key.equals("img") || key.equals("img1") || key.equals("img2")
                            || key.equals("img3") || key.equals("photo") || key.equals("logo") || key.equals("banner")) {
    ...
    public List<Map<String, Object>> getUserAllData(String deviceType, MemberUserDTO user, String date,
        ...
        switch (deviceType) {
            ...
            case "APP":
                ...
                if (sportBand == null && measureHeartrate != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.Band.name());
                ...
                if (measureBodyfatscale != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.BodyFatScale.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.BodyFatScale.value();
                }
                ...
                if (measureBloodpressure != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.BloodPressure.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.BloodPressure.value();
                }
                ...
                if (measureLunginstrument != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.Lunginstrument.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.Lunginstrument.value();
                }
                ...
                if (measureGlucometer != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.Glucometer.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.Glucometer.value();
                }
                ...
                if (ecgDTO != null && !ecgDTO.getDetailList().isEmpty()) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.ECG.name());
                    map.put(HealthPackage.STATUS, status + "");
                ...
                if (measureOxygen != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.Oxygen.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.Oxygen.value();
                }
                ...
                if (measureTemperature != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.Temperature.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.Temperature.value();
                }
                ...
                if (measureBloodLipid != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.BloodLipid.name());
                    map.put(HealthPackage.STATUS, status + "");
                    ...
                    device |= DeviceType.BloodLipid.value();
                }
                ...
                if (measureUran != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.URAN.name());
                    map.put(HealthPackage.STATUS, status + "");
                ...
                if (measureUa != null) {
                    ...
                    map.put(Normal.DEVICE_NAME, DeviceType.UA.name());
                    map.put(HealthPackage.STATUS, status + "");

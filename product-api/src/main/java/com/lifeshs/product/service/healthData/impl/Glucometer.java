...
import com.lifeshs.product.dao.healthData.IGluCometerDao;
import com.lifeshs.product.domain.dto.common.PaginationDTO;
import com.lifeshs.product.domain.dto.common.QueryPageData;
import com.lifeshs.product.domain.dto.healthData.BloodSugarDTO;
...
import com.lifeshs.product.domain.po.device.TMeasureGlucometer;
...
public class Glucometer extends MeasureDevice<TMeasureGlucometer> implements IMeasureDevice<Map<String, Object>> {
    ...
    private final DeviceType deviceType = DeviceType.Glucometer;

    @Autowired
    IGluCometerDao gluCometerDao;
    @Override

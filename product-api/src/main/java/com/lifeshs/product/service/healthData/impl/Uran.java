...
import com.lifeshs.product.dao.healthData.IUranDao;
import com.lifeshs.product.domain.dto.healthData.NormalHealthPackageDTO;
import com.lifeshs.product.domain.dto.healthData.UranDTO;
...
import com.lifeshs.product.domain.po.device.TMeasureUran;
...
public class Uran extends MeasureDevice<UranDTO> implements IMeasureDevice<UranDTO> {
    ...
    private final DeviceType deviceType = DeviceType.URAN;
    @Autowired

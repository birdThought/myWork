...
import com.lifeshs.product.dao.record.IMedicalCourseDao;
import com.lifeshs.product.dao.record.IMedicalCourseImgDao;
import com.lifeshs.product.dao.record.IMedicalDao;
import com.lifeshs.product.domain.vo.record.MedicalCourseImgPO;
import com.lifeshs.product.domain.vo.record.MedicalCoursePO;
import com.lifeshs.product.domain.vo.record.MedicalPO;
import com.lifeshs.product.domain.vo.record.MedicalBasicVO;
import com.lifeshs.product.domain.vo.record.MedicalCourseVO;
import com.lifeshs.product.domain.vo.record.MedicalSubmitVO;
...
public class MedicalServiceImpl implements IMedicalService {
    ...
    private IMedicalCourseDao courseDao;

    @Resource(name = "medicalCourseImgDao")
    private IMedicalCourseImgDao imgDao;

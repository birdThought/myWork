...
public class HeartRatePO {
    ...
    public HeartRatePO(Integer id, Integer userId, Long status, Short heartRate, String heartRateArea, String heartRateStatusDescription, Date measureDate, String deviceType, Date createDate, Short dataType) {
        this.id = id;
        this.userId = userId;
        this.status = status;

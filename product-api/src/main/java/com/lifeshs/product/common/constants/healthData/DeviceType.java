package com.lifeshs.product.common.constants.healthData;
...
public enum DeviceType {
    ...
    private DeviceType(int value, String name, String about, String shopUrl) {
        _value = value;
        _name = name;
        this.about = about;
    ...
    public static DeviceType getHealthPackageType(int value) {
        for (DeviceType h : DeviceType.values()) {
            if (h.value() == value) {
                return h;
            }
        }
